...
class RetailNewsAsiaScraper(BaseScraper):
    SOURCE_NAME = "Retail News Asia"
    ...
    def parse_article(self, url: str, page: Page) -> Dict[str, Any]:
        ...
        date_text = self.extract_text(soup, ["time.entry-date", "span.posted-on", "time"])
        ...
        return {
            ...
            "tags": ["dữ_liệu_cào", "bán_lẻ", "logistics"],
        }
